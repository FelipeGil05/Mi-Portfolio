export default function About() {
    return (
        <section
            id="about"
            className="min-h-screen relative z-10 flex items-center justify-center px-4 sm:px-6 md:px-12"
        >
            <div className="text-center w-full max-w-6xl">
                ...
                <div className="skill-card glass-effect p-6 rounded-lg shadow-xl w-full md:w-3/4 lg:w-2/3 mx-auto text-center">
